package com.sajidlatif.vasa2018.Core;
...
public class HomeActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.sajidlatif.vasa2018.R.layout.activity_home);
        ...
        ActionBarDrawerToggle toggle = new ActionBarDrawerToggle(
                this, drawer, toolbar, com.sajidlatif.vasa2018.R.string.navigation_drawer_open, com.sajidlatif.vasa2018.R.string.navigation_drawer_close);
...
//            super.onBackPressed();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(com.sajidlatif.vasa2018.R.menu.home, menu);
        return true;
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == com.sajidlatif.vasa2018.R.id.upload_date) {
        ...
        if (id == com.sajidlatif.vasa2018.R.id.stage_1) {
        ...
        if (id == com.sajidlatif.vasa2018.R.id.nav_lang_e) {
        ...
        } else if (id == com.sajidlatif.vasa2018.R.id.nav_lang_u) {
