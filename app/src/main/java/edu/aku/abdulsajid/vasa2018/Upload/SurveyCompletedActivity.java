package edu.aku.abdulsajid.vasa2018.Upload;
...
import edu.aku.abdulsajid.vasa2018.DataTables.A.A4001_A4014;
import edu.aku.abdulsajid.vasa2018.DataTables.A.A4051_A4066;
import edu.aku.abdulsajid.vasa2018.DataTables.A.A4067_A4080;
import edu.aku.abdulsajid.vasa2018.DataTables.A.A4081_A4094;
import edu.aku.abdulsajid.vasa2018.DataTables.A.A4095_A4108;
import edu.aku.abdulsajid.vasa2018.DataTables.A.A4109_A4125;
import edu.aku.abdulsajid.vasa2018.DataTables.A.A4126_A4140;
import edu.aku.abdulsajid.vasa2018.DataTables.A.A4144_A4156;
import edu.aku.abdulsajid.vasa2018.DataTables.A.A4157_A4205;
import edu.aku.abdulsajid.vasa2018.DataTables.A.A4206_A4207;
import edu.aku.abdulsajid.vasa2018.DataTables.A.A4251_A4284;
import edu.aku.abdulsajid.vasa2018.DataTables.A.A4301_A4315;
import edu.aku.abdulsajid.vasa2018.DataTables.A.A4351_A4364;
import edu.aku.abdulsajid.vasa2018.DataTables.A.A4401_A4473;
import edu.aku.abdulsajid.vasa2018.DataTables.C.C3001_C3011;
import edu.aku.abdulsajid.vasa2018.DataTables.C.C3012_C3022;
import edu.aku.abdulsajid.vasa2018.DataTables.C.C3051_C3099;
import edu.aku.abdulsajid.vasa2018.DataTables.C.C3101_C3112;
import edu.aku.abdulsajid.vasa2018.DataTables.C.C3121_C3228;
...
import edu.aku.abdulsajid.vasa2018.DataTables.C.C3351_C3364;
import edu.aku.abdulsajid.vasa2018.DataTables.C.C3401_C3457;
import edu.aku.abdulsajid.vasa2018.DataTables.C.C3471_C3472;
        ...
        StringRequest sendMyRequest = new StringRequest(Request.Method.POST, ROOT_URL,
            ...
            protected Map<String, String> getParams() {
                ...
                if (c19.getCount() > 0) {
                    ...
                    params.put("edu/aku/abdulsajid/VASMonitring/data", String.valueOf(data));
        ...
        StringRequest sendMyRequest = new StringRequest(Request.Method.POST, ROOT_URL,
            ...
            protected Map<String, String> getParams() {
                ...
                if (c3.getCount() > 0) {
                    ...
                    params.put(A4051_A4066.A051, c3.getString(c3.getColumnIndex("A4051")));
                    params.put(A4051_A4066.A052, c3.getString(c3.getColumnIndex("A4052_u")));
                    params.put(A4051_A4066.A052dx, c3.getString(c3.getColumnIndex("A4052_b")));
                    params.put(A4051_A4066.A052mx, c3.getString(c3.getColumnIndex("A4052_c")));
                    params.put(A4051_A4066.A053, c3.getString(c3.getColumnIndex("A4053")));
                    params.put(A4051_A4066.A054, c3.getString(c3.getColumnIndex("A4054")));
                    params.put(A4051_A4066.A055, c3.getString(c3.getColumnIndex("A4055")));
                    params.put(A4051_A4066.A056, c3.getString(c3.getColumnIndex("A4056")));
                    params.put(A4051_A4066.A057, c3.getString(c3.getColumnIndex("A4057")));
                    params.put(A4051_A4066.A058, c3.getString(c3.getColumnIndex("A4058")));
                    params.put(A4051_A4066.A059, c3.getString(c3.getColumnIndex("A4059_u")));
                    params.put(A4051_A4066.A059dx, c3.getString(c3.getColumnIndex("A4059_a")));
                    params.put(A4051_A4066.A059mx, c3.getString(c3.getColumnIndex("A4059_b")));
                    params.put(A4051_A4066.A060, c3.getString(c3.getColumnIndex("A4060")));
                    params.put(A4051_A4066.A061, c3.getString(c3.getColumnIndex("A4061")));
                    params.put(A4051_A4066.A062, c3.getString(c3.getColumnIndex("A4062")));
                    params.put(A4051_A4066.A063, c3.getString(c3.getColumnIndex("A4063")));
                    params.put(A4051_A4066.A064, c3.getString(c3.getColumnIndex("A4064_u")));
                    params.put(A4051_A4066.A064dx, c3.getString(c3.getColumnIndex("A4064_a")));
                    params.put(A4051_A4066.A064mx, c3.getString(c3.getColumnIndex("A4064_b")));
                    params.put(A4051_A4066.A064a, c3.getString(c3.getColumnIndex("A4064_1")));
                    params.put(A4051_A4066.A065, c3.getString(c3.getColumnIndex("A4065")));
                    params.put(A4051_A4066.A066, c3.getString(c3.getColumnIndex("A4066")));

                } else {

                    params.put(A4051_A4066.A051, "-2");
                    params.put(A4051_A4066.A052, "-2");
                    params.put(A4051_A4066.A052dx, "-2");
                    params.put(A4051_A4066.A052mx, "-2");
                    params.put(A4051_A4066.A053, "-2");
                    params.put(A4051_A4066.A054, "-2");
                    params.put(A4051_A4066.A055, "-2");
                    params.put(A4051_A4066.A056, "-2");
                    params.put(A4051_A4066.A057, "-2");
                    params.put(A4051_A4066.A058, "-2");
                    params.put(A4051_A4066.A059, "-2");
                    params.put(A4051_A4066.A059dx, "-2");
                    params.put(A4051_A4066.A059mx, "-2");
                    params.put(A4051_A4066.A060, "-2");
                    params.put(A4051_A4066.A061, "-2");
                    params.put(A4051_A4066.A062, "-2");
                    params.put(A4051_A4066.A063, "-2");
                    params.put(A4051_A4066.A064, "-2");
                    params.put(A4051_A4066.A064dx, "-2");
                    params.put(A4051_A4066.A064mx, "-2");
                    params.put(A4051_A4066.A064a, "-2");
                    params.put(A4051_A4066.A065, "-2");
                    params.put(A4051_A4066.A066, "-2");
                }
