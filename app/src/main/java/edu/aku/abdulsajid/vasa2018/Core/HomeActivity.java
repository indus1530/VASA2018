package edu.aku.abdulsajid.vasa2018.Core;
...
import edu.aku.abdulsajid.vasa2018.Pending.SurveyPendingActivity;
...
public class HomeActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private final double AppVersion = 1.1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(edu.aku.abdulsajid.vasa2018.R.layout.activity_home);
        ...
        ActionBarDrawerToggle toggle = new ActionBarDrawerToggle(
                this, drawer, toolbar, edu.aku.abdulsajid.vasa2018.R.string.navigation_drawer_open, edu.aku.abdulsajid.vasa2018.R.string.navigation_drawer_close);
...
//            super.onBackPressed();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(edu.aku.abdulsajid.vasa2018.R.menu.home, menu);
        return true;
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == edu.aku.abdulsajid.vasa2018.R.id.upload_date) {
        ...
        if (id == edu.aku.abdulsajid.vasa2018.R.id.stage_1) {
            ...
            if (intent != null)
                startActivity(intent);
            // intent = new Intent(this, edu.aku.abdulsajid.VASMonitring.RP.w204_w222.class);
            put_extr = 1;
        }/*
        ...
        if (id == edu.aku.abdulsajid.vasa2018.R.id.nav_lang_e) {
        ...
        } else if (id == edu.aku.abdulsajid.vasa2018.R.id.nav_lang_u) {
