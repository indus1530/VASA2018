...
import edu.aku.abdulsajid.vasa2018.databinding.C3251C3288BBinding;
...
public class C3251_C3288_B extends AppCompatActivity {
    ...
    //bi.btnContinue.setEnabled(false);
        ...
        if (count == 1 && ageInDays > 27 && ageInDays < 331) {
            ...
            String c32531 = db.getSpecificData(edu.aku.abdulsajid.VASMonitring.data.C.C3251_C3288_B.TABLE_NAME, bi.edStudyId.getText().toString(), Global.C.C3251_C3288_B.sub_C3251_C3288_B.C3253_1);
    ...
    public Boolean validateField() {
        ...
        //ll_C3253_1
        if (Gothrough.IamHiden(bi.rgC32531) == false) {
            return false;
        }
        //ll_ll_C3253
