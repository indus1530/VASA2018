...
import edu.aku.abdulsajid.vasa2018.databinding.N2051N2078Binding;
...
public class N2051_N2078 extends AppCompatActivity {
    ...
    private void GetDataFromDB() {
        ...
        String n2006 = db.getSpecificData(edu.aku.abdulsajid.vasa2018.data.N.N2001_N2011.TABLE_NAME, bi.edStudyId.getText().toString(), sub_N2001_N2011.N2006);
        if (n2006.equals("99") || n2006.equals("1") || n2006.equals("2")) {
            flag_n2006 = false;
        }

        String n2008 = db.getSpecificData(edu.aku.abdulsajid.vasa2018.data.N.N2001_N2011.TABLE_NAME, bi.edStudyId.getText().toString(), sub_N2001_N2011.N2008);
        if (n2008.equals("9")) {
            flag_n2008 = false;
        }

        //String q1102 = db.getSpecificData(edu.aku.abdulsajid.VASMonitring.data.GS.Q1101_Q1610.TABLE_NAME, bi.edStudyId.getText().toString(), Q1101_Q1610.Q1102);
        //if (q1102 != null) {
    ...
    public boolean SaveData() {
        ...
        n2051.setN20531(bi.cbN20531.isChecked() ? "1" : "-1");
        n2051.setN20532(bi.cbN20532.isChecked() ? "2" : "-1");
        n2051.setN20533(bi.cbN20533.isChecked() ? "3" : "-1");
        n2051.setN20534(bi.cbN20534.isChecked() ? "4" : "-1");
        n2051.setN20535(bi.cbN20535.isChecked() ? "5" : "-1");
        n2051.setN2053DK(bi.cbN2053DK.isChecked() ? "9" : "-1");
        n2051.setN2053OT(bi.cbN2053OT.isChecked() ? "6" : "-1");
        n2051.setN2053OTx(bi.edN2053OT.getText().toString().trim().length() > 0 ? bi.edN2053OT.getText().toString() : "-1");

        n2051.setN2054(bi.edN2054.getText().toString().trim().length() > 0 ? bi.edN2054.getText().toString() : "-1");
        n2051.setN2055(bi.edN2055.getText().toString().trim().length() > 0 ? bi.edN2055.getText().toString() : "-1");
        n2051.setN2056(bi.edN2056.getText().toString().trim().length() > 0 ? bi.edN2056.getText().toString() : "-1");
//        n2051.setN2057();
        n2051.setN20571(bi.rbN205711.isChecked() ? "1" : bi.rbN205712.isChecked() ? "2" : bi.rbN20571DK.isChecked() ? "9" : "-1");
        n2051.setN20572(bi.rbN205721.isChecked() ? "1" : bi.rbN205722.isChecked() ? "2" : bi.rbN20572DK.isChecked() ? "9" : "-1");
        n2051.setN20573(bi.rbN205731.isChecked() ? "1" : bi.rbN205732.isChecked() ? "2" : bi.rbN20573DK.isChecked() ? "9" : "-1");
        n2051.setN20574(bi.rbN205741.isChecked() ? "1" : bi.rbN205742.isChecked() ? "2" : bi.rbN20574DK.isChecked() ? "9" : "-1");
        n2051.setN20575(bi.rbN205751.isChecked() ? "1" : bi.rbN205752.isChecked() ? "2" : bi.rbN20575DK.isChecked() ? "9" : "-1");
        n2051.setN20576(bi.rbN205761.isChecked() ? "1" : bi.rbN205762.isChecked() ? "2" : bi.rbN20576DK.isChecked() ? "9" : "-1");
        n2051.setN20581(bi.cbN20581.isChecked() ? "1" : "-1");
        n2051.setN20582(bi.cbN20582.isChecked() ? "2" : "-1");
        n2051.setN20583(bi.cbN20583.isChecked() ? "3" : "-1");
        n2051.setN20584(bi.cbN20584.isChecked() ? "4" : "-1");
        n2051.setN20585(bi.cbN20585.isChecked() ? "5" : "-1");
        n2051.setN20586(bi.cbN20586.isChecked() ? "6" : "-1");
        n2051.setN20587(bi.cbN20587.isChecked() ? "7" : "-1");
        n2051.setN20588(bi.cbN20588.isChecked() ? "8" : "-1");
        n2051.setN20589(bi.cbN20589.isChecked() ? "9" : "-1");
        n2051.setN205810(bi.cbN205810.isChecked() ? "10" : "-1");
        n2051.setN2059(bi.rbN20591.isChecked() ? "1" : bi.rbN20592.isChecked() ? "2" : bi.rbN2059DK.isChecked() ? "9" : "-1");
        n2051.setN2060(bi.edN2060.getText().toString().trim().length() > 0 ? bi.edN2060.getText().toString() : "-1");
        n2051.setN2061(bi.rbN20611.isChecked() ? "1" : bi.rbN20612.isChecked() ? "2" : bi.rbN2061DK.isChecked() ? "9" : "-1");
        n2051.setN2062(bi.edN2062.getText().toString().trim().length() > 0 ? bi.edN2062.getText().toString() : "-1");
        n2051.setN2063(bi.rbN20631.isChecked() ? "1" : bi.rbN20632.isChecked() ? "2" : bi.rbN2063DK.isChecked() ? "9"
                : bi.rbN20633.isChecked() ? "3" : "-1");
        n2051.setN2064(bi.rbN20641.isChecked() ? "1" : bi.rbN20642.isChecked() ? "2" : bi.rbN2064DK.isChecked() ? "9" : "-1");
        n2051.setN2065(bi.edN2065.getText().toString().trim().length() > 0 ? bi.edN2065.getText().toString() : "-1");
        n2051.setN2066(bi.rbN20661.isChecked() ? "1" : bi.rbN20662.isChecked() ? "2" : bi.rbN2066DK.isChecked() ? "9"
                : bi.rbN2066RA.isChecked() ? "8" : "-1");
        n2051.setN2067(bi.edN2067.getText().toString().trim().length() > 0 ? bi.edN2067.getText().toString() : "-1");
        n2051.setN2068(bi.edN2068.getText().toString().trim().length() > 0 ? bi.edN2068.getText().toString() : "-1");
        n2051.setN20691(bi.rbN206911.isChecked() ? "1" : bi.rbN206912.isChecked() ? "2" : bi.rbN20691DK.isChecked() ? "9"
                : bi.rbN20691RA.isChecked() ? "8" : "-1");
        n2051.setN20692(bi.rbN206921.isChecked() ? "1" : bi.rbN206922.isChecked() ? "2" : bi.rbN20692DK.isChecked() ? "9"
                : bi.rbN20692RA.isChecked() ? "8" : "-1");
        n2051.setN20693(bi.rbN206931.isChecked() ? "1" : bi.rbN206932.isChecked() ? "2" : bi.rbN20693DK.isChecked() ? "9"
                : bi.rbN20693RA.isChecked() ? "8" : "-1");
        n2051.setN2070(bi.rbN20701.isChecked() ? "1" : bi.rbN20702.isChecked() ? "2" : bi.rbN2070DK.isChecked() ? "9"
                : bi.rbN2070RA.isChecked() ? "8" : "-1");
        n2051.setN2071(bi.rbN20711.isChecked() ? "1" : bi.rbN20712.isChecked() ? "2" : bi.rbN2071DK.isChecked() ? "9"
                : bi.rbN2071RA.isChecked() ? "8" : "-1");
        n2051.setN2072(bi.edN2072.getText().toString().trim().length() > 0 ? bi.edN2072.getText().toString() : "-1");
        n2051.setN2073(bi.rbN20731.isChecked() ? "1" : bi.rbN20732.isChecked() ? "2" : bi.rbN2073DK.isChecked() ? "9"
                : bi.rbN2073RA.isChecked() ? "8" : "-1");
        n2051.setN2074(bi.rbN20741.isChecked() ? "1" : bi.rbN20742.isChecked() ? "2" : bi.rbN2074OT.isChecked() ? "3"
                : bi.rbN2074DK.isChecked() ? "9" : bi.rbN2074RA.isChecked() ? "8" : "-1");
        n2051.setN2074x(bi.edN2074OT.getText().toString().trim().length() > 0 ? bi.edN2074OT.getText().toString() : "-1");
        n2051.setN2075(bi.rbN20751.isChecked() ? "1" : bi.rbN20752.isChecked() ? "2" : bi.rbN2075DK.isChecked() ? "9"
                : bi.rbN2075RA.isChecked() ? "8" : "-1");
        n2051.setN2076(bi.rbN20761.isChecked() ? "1" : bi.rbN20762.isChecked() ? "2" : bi.rbN20763.isChecked() ? "3"
                ...
                : bi.rbN2076DK.isChecked() ? "9" : "-1");
        n2051.setN2076x(bi.edN20766.getText().toString().trim().length() > 0 ? bi.edN20766.getText().toString() : "-1");
        n2051.setN2077(bi.rbN20771.isChecked() ? "1" : bi.rbN20772.isChecked() ? "2" : bi.rbN2077DK.isChecked() ? "9" : "-1");
        n2051.setN20781(bi.cbN20781.isChecked() ? "1" : "-1");
        n2051.setN20782(bi.cbN20782.isChecked() ? "2" : "-1");
        n2051.setN20783(bi.cbN20783.isChecked() ? "3" : "-1");
        n2051.setN20784(bi.cbN20784.isChecked() ? "4" : "-1");
        n2051.setN20784x(bi.edN20784.getText().toString().trim().length() > 0 ? bi.edN20784.getText().toString() : "-1");
        n2051.setN20785(bi.cbN20785.isChecked() ? "5" : "-1");
        n2051.setN20786(bi.cbN20786.isChecked() ? "6" : "-1");
        n2051.setN20787(bi.cbN20787.isChecked() ? "7" : "-1");
        n2051.setN20788(bi.cbN20788.isChecked() ? "8" : "-1");
        n2051.setN20789(bi.cbN20789.isChecked() ? "9" : "-1");
        n2051.setN207810(bi.cbN207810.isChecked() ? "10" : "-1");
        n2051.setN207811(bi.cbN207811.isChecked() ? "11" : "-1");
        n2051.setN207812(bi.cbN207812.isChecked() ? "12" : "-1");
        n2051.setN207813(bi.cbN207813.isChecked() ? "13" : "-1");
        n2051.setN2078OT(bi.cbN2078OT.isChecked() ? "14" : "-1");
        n2051.setN2078OTx(bi.edN2078OT.getText().toString().trim().length() > 0 ? bi.edN2078OT.getText().toString() : "-1");
        n2051.setN2078DK(bi.cbN2078DK.isChecked() ? "99" : "-1");
    ...
    public void onBackPressed() {
        globale.interviewExit(this, this, bi.edStudyId.getText().toString(), 6);
    }
}
