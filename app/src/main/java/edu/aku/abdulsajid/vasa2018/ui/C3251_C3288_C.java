...
import static edu.aku.abdulsajid.vasa2018.ui.C3251_C3288_A.c3251A_ID;
...
import edu.aku.abdulsajid.vasa2018.databinding.C3251C3288CBinding;
    ...
    private void GetDataFromDB() {
        ...
        for (C3251_C3288_B col_data : col_c3251) {
            if (col_data.getC32532A().equals("1")) {
                ...
                String c3064 = db.getSpecificData(edu.aku.abdulsajid.vasa2018.data.C.C3051_C3099.TABLE_NAME, bi.edStudyId.getText().toString(), C3051_C3099.C3064);
                String c3065 = null;
                ...
                for (int i = 1; i <= 8; i++) {
                    ...
                    String val;
                    if (i < 8)
                        val = db.getSpecificData(edu.aku.abdulsajid.vasa2018.data.C.C3051_C3099.TABLE_NAME, bi.edStudyId.getText().toString(), "C3065_" + i);
                    else
                        val = db.getSpecificData(edu.aku.abdulsajid.vasa2018.data.C.C3051_C3099.TABLE_NAME, bi.edStudyId.getText().toString(), C3051_C3099.C3065_DK);
                ...
                String c3066 = db.getSpecificData(edu.aku.abdulsajid.vasa2018.data.C.C3051_C3099.TABLE_NAME, bi.edStudyId.getText().toString(), C3051_C3099.C3066);
                ...
                for (int i = 1; i <= 8; i++) {
                    ...
                    String val;
                    if (i < 8)
                        val = db.getSpecificData(edu.aku.abdulsajid.vasa2018.data.C.C3051_C3099.TABLE_NAME, bi.edStudyId.getText().toString(), "C3067_" + i);
                    else
                        val = db.getSpecificData(edu.aku.abdulsajid.vasa2018.data.C.C3051_C3099.TABLE_NAME, bi.edStudyId.getText().toString(), C3051_C3099.C3067_DK);
                ...
                String c3068 = db.getSpecificData(edu.aku.abdulsajid.vasa2018.data.C.C3051_C3099.TABLE_NAME, bi.edStudyId.getText().toString(), C3051_C3099.C3068);
                String c3069 = db.getSpecificData(edu.aku.abdulsajid.vasa2018.data.C.C3051_C3099.TABLE_NAME, bi.edStudyId.getText().toString(), C3051_C3099.C3069);
                String c3070 = db.getSpecificData(edu.aku.abdulsajid.vasa2018.data.C.C3051_C3099.TABLE_NAME, bi.edStudyId.getText().toString(), C3051_C3099.C3070);
...
//        Inst_3
            String c3252 = db.getSpecificData(edu.aku.abdulsajid.vasa2018.data.C.C3251_C3288_A_C.TABLE_NAME, bi.edStudyId.getText().toString(), C3251_C3288_A_C.sub_C3251_C3288_A_C.C3252);
...
//        Inst_2 || Inst_4
    ...
    public void SetContentUI() {
        ...
        CompoundButton.OnCheckedChangeListener cbx_2240 = (compoundButton, b) -> {
        ...
        if (skip_flag == 2) {
            ClearAllcontrol.ClearAll(bi.c3254);
            bi.c3254.setVisibility(View.GONE);
        } else if (skip_flag == 9) {
            ClearAllcontrol.ClearAll(bi.llC3254C3287);
        ...
        if (!flag_c3253) {
            ClearAllcontrol.ClearAll(bi.c3254);
            bi.c3254.setVisibility(View.GONE);
            ClearAllcontrol.ClearAll(bi.llC3257C3286A);
            bi.llC3257C3286A.setVisibility(View.GONE);
            ClearAllcontrol.ClearAll(bi.llC3257C3286B);
        ...
        if (skip_flag != 9) {
            ...
            if (skip_flag != 2) {
                ...
                if (flag_c3064 && flag_c3070) {
                    if (flag_c3253) {
                        //ll_C3254
                        if (!Gothrough.IamHiden(bi.c3254)) {
                            return false;
                        }
