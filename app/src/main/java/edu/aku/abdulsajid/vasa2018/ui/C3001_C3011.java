...
public class C3001_C3011 extends AppCompatActivity implements RadioButton.OnCheckedChangeListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.setTitle(getString(R.string.h_c_sec_2_1));
    ...
    void Initialization() {
        ...
        rb_C3006_OT = findViewById(R.id.rb_C3006_OT);
        ...
        rb_C3008_OT = findViewById(R.id.rb_C3008_OT);
        rb_C3008_DK = findViewById(R.id.rb_C3008_DK);
    ...
    void events_call() {
        ...
        rb_C3006_OT.setOnCheckedChangeListener(this);
        ...
        rb_C3008_OT.setOnCheckedChangeListener(this);
        rb_C3008_DK.setOnCheckedChangeListener(this);
        ...
        ed_C3005d.setFilters(new InputFilter[]{new InputFilterMinMax(0, 6, 99, 99)});
        ed_C3005w.setFilters(new InputFilter[]{new InputFilterMinMax(1, 7, 99, 99)});
        ed_C3005d.setFilters(new InputFilter[]{new InputFilterMinMax(2, 60, 99, 99)});
        ed_C3010.setFilters(new InputFilter[]{new InputFilterMinMax(0, 5000, 9999, 8888)});
    }
    ...
    public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
        ...
        if (compoundButton.getId() == R.id.rb_C3006_1
                ...
                || compoundButton.getId() == R.id.rb_C3006_OT
                || compoundButton.getId() == R.id.rb_C3006_DK
                || compoundButton.getId() == R.id.rb_C3006_RA) {

            if (rb_C3006_6.isChecked() || rb_C3006_10.isChecked() || rb_C3006_OT.isChecked()) {
        ...
        if (compoundButton.getId() == R.id.rb_C3008_1
                ...
                || compoundButton.getId() == R.id.rb_C3008_OT
                || compoundButton.getId() == R.id.rb_C3008_DK) {
    ...
    void value_assignment() {
        ...
        } else if (rb_C3008_OT.isChecked()) {
            C3008 = "8";
        } else if (rb_C3008_DK.isChecked()) {
            C3008 = "9";
        }
    ...
    void insert_data() {
        ...
        String query = "insert into   C3001_C3011("
                + edu.aku.abdulsajid.vasa2018.DataTables.C.C3001_C3011.study_id + ","
                + edu.aku.abdulsajid.vasa2018.DataTables.C.C3001_C3011.C3001 + ","
                + edu.aku.abdulsajid.vasa2018.DataTables.C.C3001_C3011.C3002 + ","
                + edu.aku.abdulsajid.vasa2018.DataTables.C.C3001_C3011.C3003 + ","
                + edu.aku.abdulsajid.vasa2018.DataTables.C.C3001_C3011.C3004 + ","
                + edu.aku.abdulsajid.vasa2018.DataTables.C.C3001_C3011.C3005u + ","
                + edu.aku.abdulsajid.vasa2018.DataTables.C.C3001_C3011.C3005d + ","
                + edu.aku.abdulsajid.vasa2018.DataTables.C.C3001_C3011.C3005w + ","
                + edu.aku.abdulsajid.vasa2018.DataTables.C.C3001_C3011.C3005m + ","
                + edu.aku.abdulsajid.vasa2018.DataTables.C.C3001_C3011.C3006 + ","
                + edu.aku.abdulsajid.vasa2018.DataTables.C.C3001_C3011.C3006_OT + ","
                + edu.aku.abdulsajid.vasa2018.DataTables.C.C3001_C3011.C3008 + ","
                + edu.aku.abdulsajid.vasa2018.DataTables.C.C3001_C3011.C3008_OT + ","
                + edu.aku.abdulsajid.vasa2018.DataTables.C.C3001_C3011.C3009_1 + ","
                + edu.aku.abdulsajid.vasa2018.DataTables.C.C3001_C3011.C3009_2 + ","
                + edu.aku.abdulsajid.vasa2018.DataTables.C.C3001_C3011.C3009_3 + ","
                + edu.aku.abdulsajid.vasa2018.DataTables.C.C3001_C3011.C3009_4 + ","
                + edu.aku.abdulsajid.vasa2018.DataTables.C.C3001_C3011.C3010 + ","
                + edu.aku.abdulsajid.vasa2018.DataTables.C.C3001_C3011.C3011 + ","
                + edu.aku.abdulsajid.vasa2018.DataTables.C.C3001_C3011.STATUS + ") values ('" +
